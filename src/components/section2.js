...
export class Section2 extends LitElement {
    static properties = {
        urs: {type: String, attribute:"urs"},
        desc: {type: String, attribute:"desc"},
        painp: {type: String, attribute:"painp"},
    ...
    render() {
        ...
        <div class="project-overview_info">
            ...
            <div class="overview_info-box1">
                <p class="overview-titulo">${this.urs}</p>
            ...
            <p class="overview-titulo2">${this.painp}</p>
