...
export class Section1 extends LitElement {
    static properties = {
        
        titulo: {type: String, attribute:"titulo"},
        desc: {type: String, attribute:"desc"},
        respon: {type: String, attribute:"respon"},
        descrespon: {type: String, attribute:"descrespon"},
    ...
    render() {
        ...
        <div class="project-overview_header">
            ...
            <div class="box2">PROJECT OVERVIEW</div>
        ...
        <div class="project-overview_info">
            ...
            <div class="overview_info-box1">
                <p class="overview-titulo">${this.titulo}</p>
            ...
            <div class="overview_info-box3">
                <p class="overview-titulo2">${this.respon}</p>
                <p class="overview-desc2">${this.descrespon}</p>
            </div>
