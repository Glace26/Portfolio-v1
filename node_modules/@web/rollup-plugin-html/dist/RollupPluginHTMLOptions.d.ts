...
export type TransformHtmlFunction = (html: string, args: TransformHtmlArgs) => string | Promise<string>;
export type TransformAssetFunction = (content: Buffer, filePath: string) => string | Buffer | Promise<string | Buffer>;
